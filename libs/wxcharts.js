...
function drawPieDataPoints(series, opts, config, context) {
    ...
    if (opts.type === 'ring') {
        ...
        context.drawImage(opts.backgroundImage, centerPosition.x - meyiconWidth / 2, centerPosition.y - meyiconHeight / 2, meyiconWidth, meyiconHeight);
    }
...
var Charts = function Charts(opts) {
    ...
    this.context = wx.createCanvasContext(opts.canvasId, opts.component);
